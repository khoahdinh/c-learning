...
/* 49. Giải phương trình bậc hai ax^2 + bx + c = 0. Gán các nghiệm tìm được vào
x1, x2 và số lượng nghiệm (0, 1, 2) vào numRoots.*/
void getRoots(float a, float b, float c, float &x1, float &x2, int &numRoots);

// 50. Phân tích tổng số giây (totalSeconds) thành số giờ (h), số phút (m) và số
// giây (s).
